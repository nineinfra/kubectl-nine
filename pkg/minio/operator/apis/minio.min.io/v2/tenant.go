...
type TenantInterface interface {
	Create(ctx context.Context, tenant *Tenant, opts v1.CreateOptions) (*Tenant, error)
	Update(ctx context.Context, tenant *Tenant, opts v1.UpdateOptions) (*Tenant, error)
	UpdateStatus(ctx context.Context, tenant *Tenant, opts v1.UpdateOptions) (*Tenant, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*Tenant, error)
	List(ctx context.Context, opts v1.ListOptions) (*TenantList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *Tenant, err error)
	TenantExpansion
}
...
func (c *tenants) Get(ctx context.Context, name string, options v1.GetOptions) (result *Tenant, err error) {
	result = &Tenant{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tenants").
...
func (c *tenants) List(ctx context.Context, opts v1.ListOptions) (result *TenantList, err error) {
...
func (c *tenants) Create(ctx context.Context, tenant *Tenant, opts v1.CreateOptions) (result *Tenant, err error) {
	result = &Tenant{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tenants").
...
func (c *tenants) Update(ctx context.Context, tenant *Tenant, opts v1.UpdateOptions) (result *Tenant, err error) {
	result = &Tenant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tenants").
...
func (c *tenants) UpdateStatus(ctx context.Context, tenant *Tenant, opts v1.UpdateOptions) (result *Tenant, err error) {
	result = &Tenant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tenants").
...
func (c *tenants) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *Tenant, err error) {
	result = &Tenant{}
