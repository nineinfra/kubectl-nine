...
type TypeVolumeStatus string

// Enum of VolumeStatus type.
const (
	VolumeStatusPending TypeVolumeStatus = "Pending"
	VolumeStatusReady   TypeVolumeStatus = "Ready"
)

// ToVolumeStatus converts string value to VolumeStatus.
func ToVolumeStatus(value string) (status TypeVolumeStatus, err error) {
	status = TypeVolumeStatus(strings.Title(value))
	switch status {
