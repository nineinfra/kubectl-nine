...
func (req DirectPVInitRequest) getLabel(key LabelKey) LabelValue {
	...
	return &DirectPVInitRequest{
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				...
				string(CreatedByLabelKey): NodeControllerName,
				string(RequestIDLabelKey): requestID,
			},
		},
...
func (req DirectPVInitRequest) GetNodeID() NodeID {
	return NodeID(req.getLabel(NodeLabelKey))
}
